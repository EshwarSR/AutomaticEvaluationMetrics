...
conda activate base
python -u driver_wmt.py ../data/WMT18Data/system-outputs/newstest2018/cs-en/ ../data/WMT18Data/references/newstest2018-csen-ref.en bert s+wms > logs/redirect_bert_s+wms_`date +%d_%m_%Y_%H_%M_%S`.log 2>&1
