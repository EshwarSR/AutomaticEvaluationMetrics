...
conda activate base
python -u driver_wmt.py ../data/WMT18Data/system-outputs/newstest2018/tr-en/ ../data/WMT18Data/references/newstest2018-tren-ref.en glove sms > logs/redirect_glove_wmt_tr_sms_`date +%d_%m_%Y_%H_%M_%S`.log 2>&1
